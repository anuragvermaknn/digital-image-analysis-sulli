...
_FILE_PATTERN = 'raw_pathches_%s_*.tfrecord' #'flowers_%s_*.tfrecord'

# SPLITS_TO_SIZES = {'eval': 10
#                    }
...
def get_split(split_name, dataset_dir, patches_count, file_pattern=None, reader=None):
#def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  SPLITS_TO_SIZES = {'eval': patches_count
                     }
...
def main(unused_argv):
    ...
    with tf.Session() as sess:
        ...
        [image_raw, label, filename] = dataset_provider.get(['image', 'label', 'filename'])
